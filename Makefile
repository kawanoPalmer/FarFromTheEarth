...
OBJS2	=	client_main.o client_net.o client_command.o client_win.o client_sound.o
TARGET1	=	server
TARGET2	=	client
CFLAGS	=	-c -DNDEBUG
...
$(TARGET1):	$(OBJS1)
	gcc -o $(TARGET1) $(OBJS1) -lm -lSDL2 -lSDL2_image
$(TARGET2):	$(OBJS2)
	gcc -o $(TARGET2) $(OBJS2) -lm -lSDL2 -lSDL2_image -lSDL2_gfx -lSDL2_ttf -lSDL2_mixer -ljoyconlib -lhidapi-hidraw$(LDFLAGS)
...
client_sound.o: client_sound.c client_func.h common.h
